...
class HeadersToMDCFilterBean(
        ...
        @Value("\${spring.application.name:k9-sak-innsyn-api}") private val applicationName: String) : GenericFilterBean() {
    ...
    private fun putValues(req: HttpServletRequest) {
        try {
            ...
            MDCUtil.toMDC(Constants.CORRELATION_ID, req.getHeader(Constants.X_CORRELATION_ID), generator.create())
        } catch (e: Exception) {
